...
# You don't have to give the Quest a color - :SUPERLIGHTBLUE in this example. It will default to White.
   Quest.new(0, "Find a Super Rod!", "Find a Super Rod somewhere in the field. This item does not have to be handed over.", "Quest Master", "trchar039", "Queesting Town", :SUPERLIGHTBLUE, Time.now, true),
]
